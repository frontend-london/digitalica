...
$sph_messages =  Array (
	...
	"Results" => "<strong>Search results: %all</strong> - from %from to %to of %all matches (%secs sec)", //matchword will be replaced by match or matches (from this file), depending on the number of results.
	"match" => "match",     
	"matches" => "matches", 
